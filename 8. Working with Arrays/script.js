...
const dogs = [
  { weight: 22, curFood: 250, owners: ["Alice", "Bob"] },
  { weight: 8, curFood: 200, owners: ["Matilda"] },
  // { weight: 13, curFood: 191.69710117664528, owners: ["Sarah", "John"] },
  { weight: 13, curFood: 275, owners: ["Sarah", "John"] },
  { weight: 32, curFood: 340, owners: ["Michael"] },
];
...
console.log(`Sarah\`s dog eats ${sarahDog.curFood > sarahDog.recFood ? "too little" : "too much"}`);
...
//function callback
const dogEatingOKAY = (dog) => dog.curFood > dog.recFood * 0.9 && dog.curFood < dog.recFood * 1.1;
console.log(dogs.some(dogEatingOKAY));
//7
const allDogsEatingOk = dogs.filter(dogEatingOKAY);
console.log(allDogsEatingOk);

//8
const dogsCopySorted = dogs.slice().sort((dog1, dog2) => dog1.recFood > dog2.recFood);
console.log(dogsCopySorted);

// dogs.map(function (d) {
//   // console.log(d.weight);
//   d.recommendedFood = d.weight ** 0.75 * 28;
//   // console.log(d.recommendedFood);
// });
// dogs.map((d) => (d.recommendedFood = d.weight ** 0.75 * 28));
// console.log(dogs);
// const sarahDog = dogs.find((dog) => dog.owners.includes("Sarah"));
...
// // const dogEatingOK = (dog) => dog.some((dog) => dog.curFood > dog.recommendedFood * 0.9 && dog.curFood < dog.recommendedFood * 1.1);
...
// //7
// // const dogsEatingOKAY = dogs.map((dog) => (dog.curFood > dog.recommendedFood * 0.9 && dog.curFood < dog.recommendedFood * 1.1 ? dog : null));
// // console.log(dogsEatingOKAY);
// const dogsEatingOKAY = dogs.filter(dogEatingOK);
// console.log(dogsEatingOKAY);

// const dogsCopy = dogs.slice().sort((dog1, dog2) => dog1.curFood - dog2.curFood);
